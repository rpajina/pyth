...
def player_animation(direction):
    ...
    player_surf = get_image(player_spritesheet, int(player_index), direction, 15, 16, 3) #int nam zaokrouhli na cely cislo 
...
player_surf = get_image(player_spritesheet, 0, 0, 15, 16, 3) #nacte na zaklade hodnot cast toho obrazku do funkce get_image 
...
immo = False #vytvorime hodnotu pro nesmrtelnost
